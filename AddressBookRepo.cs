...
namespace AddressBookServiceDay34
{
    public class AddressBookRepo
    {
        ...
        public bool AddContact(AddressBookDetails model)
        {
            try
            {
        ...
        public void RetrieveContact()//display
        {
            try
            {
                AddressBookDetails model = new AddressBookDetails();
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
        ...
        public void EditContactUsingFirstName(AddressBookDetails model)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        public void DeleteContactUsingName(AddressBookDetails model)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    string update = "UPDATE address_book SET last_name = @Last_Name, city = @City, state = @State, email = @Email, bookname = @BookName, addressbooktype = @AddressbookType WHERE first_name = @First_Name;";
